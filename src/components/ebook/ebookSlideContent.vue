<template>
  <div class="ebook-slide-contents">
    ...
    <!-- <div class="slide-contents-list" :top="156" :bottom="48" ref="scroll" v-show="!searchVisible">
    ...
    <div class="cate_list"><div class="cate_wrapper"><ebook-category-list v-show="!searchVisible" :category="navigation"></ebook-category-list></div></div>
    <div class="slide-search-list" ref="scroll" v-show="searchVisible">
...
import EbookCategoryList from './ebookCategoryList.vue'
export default {
  mixins: [ebookMixin],
  data () {
    return {
