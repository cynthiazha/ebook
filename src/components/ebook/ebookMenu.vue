<template>
  <div class="ebook-menu">
    <transition name="slide-up">
      <div class="menu-wrapper" v-show="menuVisible" :class="{'hide-box-shadow': settingVisible >=0 || !menuVisible}">
...
export default {
  components: { ebookSettingFont, EbookFontFamilyPop, EbookSettingTheme, EbookSettingProgress, EbookSlide },
  mixins: [ebookMixin],
  methods: {
    showSetting (index) {
      this.set_setVisible(index)
    }
  }
}
</script>
